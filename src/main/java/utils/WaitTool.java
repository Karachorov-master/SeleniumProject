...
public class WaitTool {
	...
	public WebElement waitForStaleElement(WebDriver driver, By locator, int timeOutInSeconds) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOutInSeconds));
		return wait.until( ExpectedConditions.refreshed( ExpectedConditions.elementToBeClickable(locator)));
	}

	public void waitToBeScrolledToWebElement(WebDriver driver, WebElement webElement, int timeOutInSeconds) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOutInSeconds));
		wait.until(d -> {
	...
	public void waitToBeScrolledToWebElement(WebDriver driver, By locator, int timeOutInSeconds) {
